...
public class CheckCassandraUtil {
	static String[] CONTACT_POINTS = {"null","null","null","null"};
    ...
    public static void main(String[] args) {
		...
		// Connect to the cluster and keyspace "demo"
			...
			// cluster details provided with default values
		  	cluster = Cluster.builder().addContactPoints(CONTACT_POINTS).withClusterName("topology").withPort(20004).withCredentials("root", "root").build();
		  	session = cluster.connect("topology");
